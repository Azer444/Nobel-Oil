...
{
    public class PublicationReportEditViewModel
    {
        public PublicationReportEditViewModel()
        {
        ...
        public ICollection<Core.Models.PublicationReportPdf> PublicationReportPdf_AZ { get; set; }

        [Display(Name = "View PDFs (Ru)")]
        public ICollection<Core.Models.PublicationReportPdf> PublicationReportPdf_RU { get; set; }

        [Display(Name = "View PDFs (En)")]
        public ICollection<Core.Models.PublicationReportPdf> PublicationReportPdf_EN { get; set; }
    }
}
