...
namespace Data.Migrations
{
    ...
    [Migration("20220527151844_LifeAtNobelEnergyModelAdd")]
    partial class LifeAtNobelEnergyModelAdd
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Core.Models.DynamicPage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("BannerTitle_AZ")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BannerTitle_EN")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BannerTitle_RU")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("BannerTitle_TR")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentPage_AZ")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentPage_EN")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentPage_RU")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentPage_TR")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("HasPageComponent")
                        .HasColumnType("bit");
                    ...
                    b.Property<string>("PagePhotoName")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TitlePage_AZ")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TitlePage_EN")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TitlePage_RU")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("TitlePage_TR")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Models.DynamicPageContent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("ContentPhotoName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentTitle_AZ")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentTitle_EN")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentTitle_RU")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("ContentTitle_TR")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<bool>("IsContentTitle")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("Core.Models.Flatpage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.KeyAreaComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Core.Models.LifeAtNobelEnergy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("LifeAtNobelEnergies");
                });

            modelBuilder.Entity("Core.Models.LifeAtNobelEnergyPdf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("LifeAtNobelEnergyId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LifeAtNobelEnergyId");

                    b.ToTable("LifeAtNobelEnergyPdfs");
                });

            modelBuilder.Entity("Core.Models.MainSustainabilityReport", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("MainSustainabilityReport");
                });
            ...
            modelBuilder.Entity("Core.Models.OurStrategyComponent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("OurStrategyComponents");
                });
            ...
            modelBuilder.Entity("Core.Models.PublicationReportPdf", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("PublicationReportId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PublicationReportId");

                    b.ToTable("PublicationReportPdfs");
                });
            ...
            modelBuilder.Entity("Core.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "43060af1-a5d0-4568-bae5-5f9cfac3a9c8",
                            Name = "Manager",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6c9e355b-ab6b-421b-819b-51bee2223c26",
                            Name = "Admin",
                        ...
                        new
                        {
                            ...
                            ConcurrencyStamp = "6f280e98-4470-45f9-a496-0b2310ae7667",
                            Name = "Staff",
            ...
            modelBuilder.Entity("Core.Models.SustainabilityReport", b =>
                {
                    ...
                    b.Property<string>("FileName_AZ")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FileName_EN")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FileName_RU")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("FileName_TR")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            AccessFailedCount = 0,
                            ConcurrencyStamp = "a9b43cb9-6332-49ee-8883-5a6d50bcfc46",
                            CreatedAt = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            NormalizedUserName = "NOBEL_MANAGER",
                            PasswordHash = "AQAAAAEAACcQAAAAEMRetdwIw1PKYg2sz7EsZ7E8d7o3eQ4XpV7IymSMCO6SFk65tycwFUDRxb9Acvt7cg==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "1125f595-4979-4d7f-b5d4-b7de49b853a9",
            ...
            modelBuilder.Entity("Core.Models.DynamicPageContent", b =>
                {
                    b.HasOne("Core.Models.DynamicPage", "DynamicPage")
                        .WithMany("DynamicPageContents")
            ...
            modelBuilder.Entity("Core.Models.LifeAtNobelEnergyPdf", b =>
                {
                    b.HasOne("Core.Models.LifeAtNobelEnergy", "LifeAtNobelEnergy")
                        .WithMany("LifeAtNobelEnergyPdfs")
                        .HasForeignKey("LifeAtNobelEnergyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LifeAtNobelEnergy");
                });
            ...
            modelBuilder.Entity("Core.Models.PublicationReportPdf", b =>
                {
                    b.HasOne("Core.Models.PublicationReport", "PublicationReport")
                        .WithMany("PublicationReportPdfs")
                        .HasForeignKey("PublicationReportId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("PublicationReport");
                });
            ...
            modelBuilder.Entity("Core.Models.DynamicPage", b =>
                {
                    b.Navigation("DynamicPageContents");
                });
            ...
            modelBuilder.Entity("Core.Models.LifeAtNobelEnergy", b =>
                {
                    b.Navigation("LifeAtNobelEnergyPdfs");
                });
            ...
            modelBuilder.Entity("Core.Models.PublicationReport", b =>
                {
                    b.Navigation("PublicationReportPdfs");
                });
